...
public:
	...
	/// Web service receive of HTTP Accept acknowledgment for one-way send operation 'send_Hello' (returns error code or
	/// SOAP_OK)
	virtual int recv_Hello_empty_response()
	{
		return soap_recv_empty_response(this->soap);
	}
	/// Web service one-way synchronous send operation 'Hello' with HTTP Accept/OK response receive (returns error code or
	/// SOAP_OK)
	...
	/// Web service receive of HTTP Accept acknowledgment for one-way send operation 'send_Bye' (returns error code or
	/// SOAP_OK)
	virtual int recv_Bye_empty_response()
	{
		return soap_recv_empty_response(this->soap);
	}
	/// Web service one-way synchronous send operation 'Bye' with HTTP Accept/OK response receive (returns error code or
	/// SOAP_OK)
	...
	/// Web service receive of HTTP Accept acknowledgment for one-way send operation 'send_Probe' (returns error code or
	/// SOAP_OK)
	virtual int recv_Probe_empty_response()
	{
		return soap_recv_empty_response(this->soap);
	}
	/// Web service one-way synchronous send operation 'Probe' with HTTP Accept/OK response receive (returns error code or
	/// SOAP_OK)
	...
	/// Web service receive of HTTP Accept acknowledgment for one-way send operation 'send_ProbeMatches' (returns error
	/// code or SOAP_OK)
	virtual int recv_ProbeMatches_empty_response()
	{
		return soap_recv_empty_response(this->soap);
	}
	/// Web service one-way synchronous send operation 'ProbeMatches' with HTTP Accept/OK response receive (returns error
	/// code or SOAP_OK)
	...
	/// Web service receive of HTTP Accept acknowledgment for one-way send operation 'send_Resolve' (returns error code or
	/// SOAP_OK)
	virtual int recv_Resolve_empty_response()
	{
		return soap_recv_empty_response(this->soap);
	}
	/// Web service one-way synchronous send operation 'Resolve' with HTTP Accept/OK response receive (returns error code
	/// or SOAP_OK)
	...
	/// Web service receive of HTTP Accept acknowledgment for one-way send operation 'send_ResolveMatches' (returns error
	/// code or SOAP_OK)
	virtual int recv_ResolveMatches_empty_response()
	{
		return soap_recv_empty_response(this->soap);
	}
	/// Web service one-way synchronous send operation 'ResolveMatches' with HTTP Accept/OK response receive (returns
