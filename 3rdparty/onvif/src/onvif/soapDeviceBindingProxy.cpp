...
int DeviceBindingProxy::GetServiceCapabilities(
		const char* endpoint, const char* soap_action, _tds__GetServiceCapabilities* tds__GetServiceCapabilities,
...
int DeviceBindingProxy::GetRemoteDiscoveryMode(
		const char* endpoint, const char* soap_action, _tds__GetRemoteDiscoveryMode* tds__GetRemoteDiscoveryMode,
...
int DeviceBindingProxy::SetRemoteDiscoveryMode(
		const char* endpoint, const char* soap_action, _tds__SetRemoteDiscoveryMode* tds__SetRemoteDiscoveryMode,
...
int DeviceBindingProxy::SetRelayOutputSettings(
		const char* endpoint, const char* soap_action, _tds__SetRelayOutputSettings* tds__SetRelayOutputSettings,
...
int DeviceBindingProxy::GetDot1XConfigurations(
		const char* endpoint, const char* soap_action, _tds__GetDot1XConfigurations* tds__GetDot1XConfigurations,
